...
void menu() {
    ...
    loadimage(&logo_img, _T("D:\\Tankfight_source\\resources\\image\\logo.bmp"), 433, 147);
    ...
    loadimage(&illustrate_img, _T("D:\\Tankfight_source\\resources\\image\\illustrate.jpg"), 300, 300);
